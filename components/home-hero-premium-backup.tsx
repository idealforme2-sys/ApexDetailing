...
export function HomeHero() {
  return (
    <section className="relative flex min-h-[95vh] items-center overflow-hidden pt-24 pb-16">
      ...
      <div className="site-container relative z-10 w-full">
        <div className="grid gap-12 lg:grid-cols-[1.25fr_0.75fr] lg:gap-16 xl:grid-cols-[1.3fr_0.7fr] items-center">
          ...
          <Reveal className="flex flex-col justify-center py-8">
            ...
            <h1 className="mt-8 max-w-4xl font-display text-5xl uppercase leading-[0.95] tracking-[0.06em] text-white sm:text-7xl lg:text-[4.5rem] xl:text-8xl">
              Premium mobile detailing with a finish that feels <span className="text-transparent bg-clip-text bg-gradient-to-b from-white to-white/50">showroom fresh.</span>
            </h1>
            
            <p className="mt-8 max-w-xl text-base leading-8 text-slate-300 sm:text-lg">
              Apex brings refined interior and exterior detailing to your driveway, so your vehicle looks sharper without taking time out of your day.
            </p>

            <div className="mt-10 flex flex-wrap gap-4">
              <Link href={business.phoneHref} className="btn-primary group text-sm px-8 py-4 shadow-[0_0_30px_-5px_rgba(42,168,255,0.4)]">
                Call Now
                <Phone className="h-4 w-4 transition-transform group-hover:scale-110" />
              </Link>
              <Link href="/contact" className="btn-secondary group text-sm px-8 py-4 bg-white/5 border-white/10 backdrop-blur-md hover:bg-white/10">
                Get a Quote
            ...
            <div className="mt-12 flex flex-wrap gap-3">
              {[business.serviceArea, ...business.highlights].map((item) => (
                <span key={item} className="inline-flex items-center rounded-full border border-white/10 bg-white/5 px-4 py-2 text-[0.7rem] uppercase tracking-[0.2em] text-slate-200 backdrop-blur-md transition-colors hover:bg-white/10">
                  {item}
                </span>
              ))}
            </div>
          ...
          <Reveal delay={0.15} className="flex flex-col justify-center">
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-1">
              ...
              <div className="group relative overflow-hidden rounded-[2rem] border border-white/10 bg-black/40 p-6 shadow-2xl backdrop-blur-xl transition-colors hover:border-white/20 sm:p-8">
                <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_right,rgba(42,168,255,0.15),transparent_60%)] transition-opacity duration-500 group-hover:opacity-100 opacity-60" />
                <div className="relative z-10">
                  ...
                  <p className="mt-3 text-sm leading-7 text-slate-300">
                    Recent gloss shots, interior cleanups, and hand-backs from the kind of work people are actually booking Apex for.
                  </p>
                  ...
                  <div className="mt-8 flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-400 mt-1">Check us out</p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="relative z-10 flex flex-col h-full justify-between gap-6">
                  <div>
                    ...
                    <p className="mt-2 text-sm leading-6 text-slate-300">
                      Interior deep clean, exterior hand wash, tire shine, and streak-free windows.
                    </p>
                  </div>
